...
/*
casper.start('http://www.aymoo.com/a.php');
...
/*casper.start('http://www.tmall.com', function(){
    this.fillSelectors("form[name='searchTop']", {
        'input[name="q"]': 'bra'
    }, true);
});
casper.then(function(){
...
casper.wait(2000, function(){
    title = casper.evaluate(function(){
        ...
        document.querySelector('input[name="q"]').setAttribute('value', 'bra');
        document.querySelector('form[name="searchTop"]').submit();
        //return document.querySelector('input[name="q"]').getAttribute('value');
        return "aaa";
    });
    /*this.fillSelectors("form[name='searchTop']", {
        'input[name="q"]': 'bra'
